...
public class Main {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("A101", "Hyundai", "Creta", 1200.0); // Different base price per day for each car
        ...
        while (true) {
            ...
            System.out.println("Enter 2 : User");
            ...
            if (choice == 2) {
                ...
                while (i.equalsIgnoreCase("y")) {
                    ...
                    Car carNew = new Car(carId, brand, model, price);
                    rentalSystem.addCar(carNew);
                    System.out.println("Add New Car : (Y/N)");
                    i = sc.nextLine();
                }
